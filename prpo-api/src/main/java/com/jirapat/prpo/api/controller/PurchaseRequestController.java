...
import com.jirapat.prpo.api.service.PurchaseRequestExcelExportService;
import com.jirapat.prpo.api.service.PurchaseRequestPdfExportService;
import com.jirapat.prpo.api.service.PurchaseRequestService;
...
public class PurchaseRequestController {
    ...
    private final PurchaseRequestPdfExportService pdfExportService;
    ...
    @GetMapping("/{id}/pdf")
    public ResponseEntity<byte[]> exportPurchaseRequestPdf(@PathVariable UUID id) {
        byte[] pdfBytes = pdfExportService.exportToPdf(id);
        String filename = "PR-" + id + ".pdf";
